...
const STRINGS = {
  ...
  // chat
  // Opens with a QUESTION, not a menu. The old greeting described what Sathi
  // was and then left the citizen at a blank box — the same dead end as a
  // scheme portal's search bar. Asking "what do you need the money for?" is
  // something anyone can answer without knowing a single scheme name, and the
  // starter chips below it (ChatPage's STARTERS) make answering a single tap.
  "chat.greeting": { en: "Namaste! I am Sathi.\n\nTell me what you need the money for — I'll find the government scheme that actually covers it, and check whether you qualify. You can tap an option below, type, or press the mic and just talk.", hi: "नमस्ते! मैं साथी हूं।\n\nबताइए पैसे किस काम के लिए चाहिए — मैं उसी के लिए सही सरकारी योजना ढूंढूंगा और देखूंगा कि आप पात्र हैं या नहीं। नीचे कोई विकल्प दबाएं, लिखें, या माइक दबाकर बोलें।", bn: "নমস্তে! আমি সাথী।\n\nবলুন টাকাটা কীসের জন্য দরকার — আমি ঠিক সেই সরকারি প্রকল্প খুঁজে দেব এবং দেখব আপনি যোগ্য কি না। নিচে একটি অপশনে চাপুন, লিখুন, বা মাইক চেপে বলুন।", ta: "வணக்கம்! நான் சாத்தி.\n\nபணம் எதற்காக வேண்டும் என்று சொல்லுங்கள் — அதற்கான சரியான அரசுத் திட்டத்தைக் கண்டுபிடித்து, நீங்கள் தகுதியானவரா என்று பார்க்கிறேன். கீழே ஒன்றைத் தட்டுங்கள், தட்டச்சு செய்யுங்கள், அல்லது மைக்கை அழுத்திப் பேசுங்கள்.", te: "నమస్తే! నేను సాథి.\n\nడబ్బు దేని కోసం కావాలో చెప్పండి — దానికి సరిపోయే ప్రభుత్వ పథకాన్ని కనుగొని, మీరు అర్హులా అని చూస్తాను. కింద ఒకదాన్ని నొక్కండి, టైప్ చేయండి, లేదా మైక్ నొక్కి మాట్లాడండి.", mr: "नमस्कार! मी साथी.\n\nपैसे कशासाठी हवेत ते सांगा — त्यासाठीची नेमकी सरकारी योजना शोधून तुम्ही पात्र आहात का ते पाहीन. खाली एक पर्याय दाबा, लिहा, किंवा माइक दाबून बोला." },
  "chat.startersHint": { en: "Tap one to start —", hi: "शुरू करने के लिए कोई एक दबाएं —", bn: "শুরু করতে একটিতে চাপুন —", ta: "தொடங்க ஒன்றைத் தட்டுங்கள் —", te: "ప్రారంభించడానికి ఒకదాన్ని నొక్కండి —", mr: "सुरू करण्यासाठी एक दाबा —" },
  "chat.questionProgress": { en: "Question {n} of {total}", hi: "सवाल {n} / {total}", bn: "প্রশ্ন {n} / {total}", ta: "கேள்வி {n} / {total}", te: "ప్రశ్న {n} / {total}", mr: "प्रश्न {n} / {total}" },
  ...
  "chat.continueApplication": { en: "Continue with application", hi: "आवेदन जारी रखें", bn: "আবেদন চালিয়ে যান", ta: "விண்ணப்பத்தைத் தொடரவும்", te: "దరఖాస్తును కొనసాగించండి", mr: "अर्ज सुरू ठेवा" },
  // disclaimers — Yojna Sarthi is an independent helper, not a government site
  "disclaimer.site": {
    en: "Yojna Sarthi is an independent helper, not a government website. Always confirm eligibility and apply on the official government portal.",
    hi: "योजना सारथी एक स्वतंत्र सहायक है, कोई सरकारी वेबसाइट नहीं। पात्रता की पुष्टि करें और आधिकारिक सरकारी पोर्टल पर ही आवेदन करें।",
    bn: "যোজনা সারথি একটি স্বাধীন সহায়ক, কোনো সরকারি ওয়েবসাইট নয়। যোগ্যতা যাচাই করুন এবং সরকারি অফিসিয়াল পোর্টালেই আবেদন করুন।",
    ta: "யோஜ்னா சாரதி ஒரு சுயாதீன உதவியாளர், அரசு இணையதளம் அல்ல. தகுதியை உறுதிசெய்து அதிகாரப்பூர்வ அரசு போர்ட்டலில் மட்டுமே விண்ணப்பியுங்கள்.",
    te: "యోజన సారథి ఒక స్వతంత్ర సహాయకుడు, ప్రభుత్వ వెబ్‌సైట్ కాదు. అర్హతను నిర్ధారించుకుని అధికారిక ప్రభుత్వ పోర్టల్‌లోనే దరఖాస్తు చేయండి.",
    mr: "योजना सारथी हा एक स्वतंत्र मदतनीस आहे, सरकारी संकेतस्थळ नाही. पात्रतेची खात्री करा आणि अधिकृत सरकारी पोर्टलवरच अर्ज करा.",
  },
  "disclaimer.ai": {
    en: "Sathi can make mistakes. Verify eligibility on the official portal before applying.",
    hi: "साथी से गलती हो सकती है। आवेदन से पहले आधिकारिक पोर्टल पर पात्रता जांचें।",
    bn: "সাথী ভুল করতে পারে। আবেদনের আগে অফিসিয়াল পোর্টালে যোগ্যতা যাচাই করুন।",
    ta: "சாத்தி தவறு செய்யலாம். விண்ணப்பிக்கும் முன் அதிகாரப்பூர்வ போர்ட்டலில் தகுதியைச் சரிபார்க்கவும்.",
    te: "సాథి పొరపాట్లు చేయవచ్చు. దరఖాస్తుకు ముందు అధికారిక పోర్టల్‌లో అర్హతను ధృవీకరించండి.",
    mr: "साथीकडून चूक होऊ शकते. अर्ज करण्यापूर्वी अधिकृत पोर्टलवर पात्रता तपासा.",
  },
};
